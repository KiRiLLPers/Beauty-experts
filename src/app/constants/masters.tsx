...
import photo6 from '../../images/SectionMasters/kolesnikova.png'
import photo7 from '../../images/SectionMasters/maslenkina.png'
import photo8 from '../../images/SectionMasters/nesterova.png'
import photo9 from '../../images/SectionMasters/osadchaia.png'
import photo10 from '../../images/SectionMasters/paseka.png'
import photo11 from '../../images/SectionMasters/uglova.png'
import photo12 from '../../images/SectionMasters/yulia.png'
import photo13 from '../../images/SectionMasters/zaharevich.png'
import photo14 from '../../images/SectionMasters/zherebcova.png'
import photo15 from '../../images/SectionMasters/zhorova.png'
...
export const masters: Master[] = [
    ...
    },
    {
        ...
        description: 'Я beauty-специалист и создатель авторских мастерклассов, инфлюэнсер модной аудитории. Также являюсь основательнецей авторских проектов для визажистов. Мой основной посыл — это быть всегда актуальной, молодой и гореть своим делом. Главная задача макияжа - он должен украшать.',
    ...
    },
    {
        ...
        name: 'Татьяна Углова',
        profile: 'косметолог',
        description: 'Я мастер косметолог с огромным запасом опыта и знаний. Я была одной из первых, кто внес значительный вклад в развитие современной косметологии Новосибирска и превнесла немало тенденций в эту область. Меня всегда привлекала возможность помогать людям чувствовать себя уверенно и прекрасно, и я продолжаю радовать своих клиентов по сей день.',
        experience: 'более 30 лет опыта',
        icon: cosmetologist,
        photo: photo11,
    },
    ...
    },
    {
        ...
        profile: 'топ-стилист',
        description: 'Моя любовь к красивым волосам переросла в любимую профессию, которая дает возможность мне быть трендсеттером и амбассадором модных стрижек и окрашиваний.',
    ...
    },
    {
        ...
        name: 'София Осадчая',
        profile: 'визажист',
        description: 'Я верю, что каждый человек обладает особенной красотой, и моя задача - подчеркнуть ее и сделать ее ярче с помошью правильного макияжа. Я всегда ищу новые техники и тренды, чтобы быть в курсе самых актуальных новинок. Радость, которую я вижу на лицах своих клиентов, дает мне стимул и мотивацию для совершенствования своего мастерства.',
        experience: '13 лет опыта',
        icon: visagiste,
        photo: photo9,
    },
    ...
    },
    {
        ...
        profile: 'топ-стилист',
        description: 'Как профессионал своего дела, я обладаю огромным опытом и мастерством. За моими плечами находятся как обучения у выдающихся российских мастеров, так и тесное знакомство с европейскими школами. Для работа - это творческий процесс, который приносит мне огромное удовольствие, особенно когда я вижу счастливые лица своих клиентов, которые снова и снова возвращаются ко мне.',
        experience: 'более 30 лет опыта',
        icon: cosmetologist,
        photo: photo6,
    },
